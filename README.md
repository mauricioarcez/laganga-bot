...
- **Limpieza de Historial**: El workflow `.github/workflows/cleanup_db.yml` se ejecuta el 1 de cada mes para vaciar la base de datos de ofertas publicadas, permitiendo que ofertas antiguas vuelvan a ser elegibles.
